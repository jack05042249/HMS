...
const exception = ['/basic-api/', '/basic-api/login', '/basic-api/forgotPassword', '/basic-api/reset-password', '/basic-api/public/', '/basic-api/postcards/', '/public/', '/basic-api/telegram/webhook',
    // '/signupnewmannager'
];
