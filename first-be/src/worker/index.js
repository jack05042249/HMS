...
const weeklyNotification = cron.schedule('0 0 12 * * 7', async () => {
    ...
    */
    ...
    const weekAfter = moment().startOf('d').add(0, 'week')
...
const everyDayCron = cron.schedule(everyDay9AM, async () => {
...
const linkedinCron = cron.schedule('58 0 * * *', async () => {
